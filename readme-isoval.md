...
```
JPEG_BIN=./jpeg IVT=0.50 ./jpeg-isoval-add.sh in.png
JPEG_BIN=./jpeg IVT=0.40 ./jpeg-isoval-mul.sh in.png
JPEG_BIN=./jpeg IVTAUTO=avg ./jpeg-isoval-add.sh in.png
JPEG_BIN=./jpeg IVTAUTO=avg ./jpeg-isoval-mul.sh in.png
JPEG_BIN=./jpeg IVTAUTO=max ./jpeg-isoval-add.sh in.png
JPEG_BIN=./jpeg IVTAUTO=max ./jpeg-isoval-mul.sh in.png
JPEG_BIN=./jpeg IVTAUTO=min ./jpeg-isoval-add.sh in.png
JPEG_BIN=./jpeg IVTAUTO=min ./jpeg-isoval-mul.sh in.png
```
...
1) Note that `IVTAUTO` mode `min` with `ISOVAL` mode `mul` makes no sense.
